...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  IconData _getCategoryIcon(String category) {
    ...
    if (category.contains('تسوق') || category.contains('شراء') || category.contains('مشتريات')) return Icons.shopping_bag_rounded;
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              // 🔹 التعديل هنا: استخدام FormatHelper وزيادة سماكة الخط
                              trailing: Text(
                                '${FormatHelper.formatNumber(expense.amount)} ${provider.currency.tr()}',
                                style: TextStyle(
        ...
        children: [
          ...
          if (_searchQuery.isNotEmpty || _selectedCategory != 'الكل') ...[
            ...
            TextButton.icon(
              ...
              label: Text('مسح الفلاتر'.tr(), style: const TextStyle(fontWeight: FontWeight.bold)),
            )
          ]
        ],
      ),
